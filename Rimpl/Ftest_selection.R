...
#write(features, file.path(dirname(df_dir), "F-test_featurecs.txt"))
# write(features, file.path(dirname(df_dir), "features.txt"))
write(features, file.path(dirname(df_dir), "sub_features.txt"))
